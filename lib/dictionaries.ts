export const dict = {
  US: {
    ...
    rights: "Daffa Pratama. All rights reserved.",
    
    // Home Page
    greeting: "Hi, I'm Daffa Pratama",
  ...
  ID: {
    ...
    rights: "Daffa Pratama. Hak cipta dilindungi.",
    
    // Home Page
    greeting: "Hai, Saya Daffa Pratama",
    basedIn: "Berbasis di Bandung, Indonesia",
